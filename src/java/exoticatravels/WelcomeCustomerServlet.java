 ...
 * @author Vishal Singh
 */
@WebServlet(name = "WelcomCustomerServlet", urlPatterns = {"/WelcomCustomerServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           /* out.println("<td><font color='darkblue' size='+1'><a href='DomesticFlights'>Domestic Flights</a></td>");
            ...
            out.println("<td><font color='darkblue' size='+1'><a href='"+response.encodeURL("HomePage")+"'>Hotels</a></td>");
