 ...
 * @author Vishal Singh
 */
@WebFilter(filterName = "IPFilter", urlPatterns = {"/IPFilter"}, initParams = {
    @WebInitParam(name = "validip", value = "172.22.76.183")})
public class IPFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
            ...
            throws IOException, ServletException 
       {
           ...
           {
            RequestDispatcher rd=request.getRequestDispatcher("/RegistrationServlet.jsp");
            rd.forward(request, response);
           }
