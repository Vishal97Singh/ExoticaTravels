...
public class HomePage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // out.println("<img src='Images/exotica.png' width='250' height='150' align='left'/>");
            out.println("<B><I><font style='font-family: 'Brush Script MT Italics',Gadget, sans-serif;' size='+1' color='darkblue'><marquee> <h2>Welcome to Exotic Travels. We are here to make your trip wonderful</h2></marquee></B></I>");
            out.println("<br/>");
            out.println("<form method='post' action='/SubmitServlet'>");
            out.println("<table cellspacing='10' align='center'>");
            out.println("<tr>");
            out.println("<td><fontcolor='darkblue' size='+2'>LOGIN AS:");
            out.println("</tr>");
            out.println("</td>");
            out.println("</table>");
